...
@onready var areas: Array[Node] = [$missSheep, $clock, $window]

var fade_time := 1.0
var visitedCount := 0

var finalConversation: Array[Dictionary] = [
	{"name": "Detective Fox", "text": "(Now we should go see Chief Teddy.)"},
	{"name": "Detective Fox", "text": "(We need to ask him about the password and the stolen documents.)"}
]
